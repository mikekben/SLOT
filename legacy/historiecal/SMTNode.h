...
namespace SLOT
{
  ...
  class FloatingNode : public SMTNode
  {
    public:
      ...
      inline rounding_mode RoundingMode() { return (contents.arg(0).get_sort().sort_kind() == 	Z3_ROUNDING_MODE_SORT) ? contents.arg(0) : RNE; }
      inline bool IsRNE() { return RoundingMode() == RNE; }
